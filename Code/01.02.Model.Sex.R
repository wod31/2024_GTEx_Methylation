...
# @Description: Model sex effects only in old (> 60 years) individuals
...
saveRDS(res_2, paste0(project_path, "/Tissues/", tissue, "/DML_results_5_PEERs_continous.peer.OldSex.rds")) #This is the final model we are using
# saveRDS(res_2, paste0(project_path, "/Tissues/", tissue, "/DML_results_no_BMI.rds")) 
print("Using 5 PEERs:")
print(paste0("  Sex: ", sum(res_2$SEX2$adj.P.Val<0.05)))
print(paste0("  Sex:Hyper: ", nrow(res_2$SEX2[res_2$SEX2$adj.P.Val<0.05 & res_2$SEX2$logFC>0,])))
